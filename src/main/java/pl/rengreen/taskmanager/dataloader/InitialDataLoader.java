...
public class InitialDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        taskService.createTask(new Task(
                ...
                today.minusDays(40),
                true,
                userService.getUserByEmail("correaleon1999@gmail.com").getName(),
                userService.getUserByEmail("correaleon1999@gmail.com")
        ));
        ...
        taskService.createTask(new Task(
                ...
                today.minusDays(30),
                true,
                userService.getUserByEmail("abdulrahmaan2585@gmail.com").getName(),
                userService.getUserByEmail("abdulrahmaan2585@gmail.com")
        ));
        ...
        taskService.createTask(new Task(
                ...
                today.minusDays(5),
                false,
                userService.getUserByEmail("dummymanager2563086@gmail.com").getName(),
                userService.getUserByEmail("kate@mail.com")
        ));
        ...
        taskService.createTask(new Task(
                ...
                false,
                userService.getUserByEmail("dummymanager2563086@gmail.com").getName(),
                userService.getUserByEmail("dummymanager2563086@gmail.com")
        ));
